...
- `울산_3반_이상수_DAY1_과제1_정규화.pdf`: 과제 1(B-1) 독립 제출용 PDF, 4페이지
- `울산_3반_이상수_DAY1_과제2_단일테이블조회.pdf`: 과제 2(B-2) 독립 제출용 PDF, 3페이지
...
- DOCX 접근성 검사: 경고 0건
- 최종 PDF: 태그 포함, 8페이지
- 과제별 PDF: 과제 1 전체 4페이지 및 과제 2 전체 3페이지 렌더링 검수 완료
